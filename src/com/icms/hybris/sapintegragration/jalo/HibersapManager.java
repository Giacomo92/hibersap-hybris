...
/**
 * This is the extension manager of the Hibersap extension.
 */
public class HibersapManager extends GeneratedHibersapManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HibersapManager.class.getName());
	 ...
	 */
	public static HibersapManager getInstance()
	{
		return (HibersapManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HibersapConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HibersapManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HibersapManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HibersapManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HibersapManager called, current tenant: " + getTenant().getTenantID());
		}
	}
